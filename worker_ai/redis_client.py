...
def get_redis_client() -> redis_lib.Redis:
    """See worker/redis_client.py's identical function - kept as its own
    copy because backend/worker/security/worker_ai are separate Docker
    build contexts that don't share a package."""
